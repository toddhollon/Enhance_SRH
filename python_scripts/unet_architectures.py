...
def unet(img_w = 256, img_h = 256, img_channls = 3, data_format='channels_last'):
    inputs = Input((img_w, img_h, img_channls))
    x = inputs
    depth = 4
    features = 64
    skips = []
...
########################################################################################################
#Attention U-Net
def att_unet(img_w = 256, img_h = 256, img_channls = 3, data_format='channels_last'):
    inputs = Input((img_w, img_h, img_channls))
    x = inputs
    depth = 4
    features = 64
...
########################################################################################################
#Recurrent Residual Convolutional Neural Network based on U-Net (R2U-Net)
def r2_unet(img_w = 256, img_h = 256, img_channls = 3, data_format='channels_last'):
    inputs = Input((img_w, img_h, img_channls))
    x = inputs
    depth = 4
    features = 64
...
########################################################################################################
#Attention R2U-Net
def att_r2_unet(img_w = 256, img_h = 256, img_channls = 3, data_format='channels_last'):
    inputs = Input((img_w, img_h, img_channls))
    x = inputs
    depth = 4
    features = 64
